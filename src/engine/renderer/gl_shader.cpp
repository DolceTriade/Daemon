...
GLShader_lightMapping::GLShader_lightMapping() :
    ...
    u_ShadowTileInfo( this ),
    u_ShadowLightInfo( this ),
    u_CascadeSplits( this ),
    u_ShadowTechnique( this ),
    u_ShadowInverseBiasScale( this ),
    u_ShadowInverseNormalOffsetScale( this ),
    u_ShadowInverseDepthSeparation( this ),
    u_ShadowInverseOcclusionThreshold( this ),
    u_ShadowInverseSelfRejectDepth( this ),
    u_RealtimeLightNormalScale( this ),
    u_RealtimeLightSpecularScale( this ),
    u_TextureMatrix( this ),
