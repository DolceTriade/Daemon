...
static Cvar::Cvar<float> r_debugProjLightAngle( "r_debugProjLightAngle", "debug projected angle", Cvar::NONE, 60.0f );
...
static void AddDebugProjectedLight() {
	...
	*light = {};
	...
	VectorScale(light->projUp, tanf(DEG2RAD(r_debugProjLightAngle.Get())) / upLen / tgtLen, light->projUp);
