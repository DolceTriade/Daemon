...
//
	...
	extern Cvar::Cvar<bool> r_inverseGlobalLight;
	extern Cvar::Range<Cvar::Cvar<float>> r_inverseGlobalYaw;
	extern Cvar::Range<Cvar::Cvar<float>> r_inverseGlobalPitch;
	extern Cvar::Range<Cvar::Cvar<float>> r_inverseGlobalIntensity;
	extern Cvar::Range<Cvar::Cvar<float>> r_inverseGlobalColorR;
